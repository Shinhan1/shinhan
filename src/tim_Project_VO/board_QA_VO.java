package tim_Project_VO;

import tim_Project_Dao.board_FAQ_Dao;
...
public class board_QA_VO {
	...
	public board_QA_VO(int qa_bno, String qa_id, String qa_title, String qa_inquiry,
			String qa_date, String qa_contents, String qa_email, String qa_img, String qa_ip, int qa_status, int qa_hits) {
		super();
		this.qa_bno = qa_bno;
