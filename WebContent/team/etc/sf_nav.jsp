...
<div class="navi_menu_div">
            <div class="navi_logo_div"><!-- 로고 부분  -->
                <a href="../safety/safetyMain.jsp" class="link"><img src="../image/sf_logo.png" alt="safetyLogo" id="navi_logo"/></a>
            </div>
            ...
            <div class="support_btn_div"> <!-- 후원하기 버튼 -->
                <a href="../safety/safetyLogin.jsp"><input type="button" value="후원하기" id="support_btn"/></a>
            </div>
...
<div class="list_hide_div">
            <div class="list_hide1">
                <ul class="hide_ul1">
                    <!-- 소개 세부 -->
                    <li class="hide_li">
                        <a href="../Introduce/introduce.jsp" class="navi_hide_a">세이프티 스토리</a>
                    </li>
                    <li class="hide_li">
            ...
            <div class="list_hide2">
                ...
                <ul class="hide_ul2">
                    <!-- 소개 세부 -->
                    <li class="hide_li">
                        <a href="introduce.jsp" class="navi_hide_a">단체후원</a>
                    </li>
                    <li class="hide_li">
                        <a href="" class="navi_hide_a">개인후원</a>
                    </li>
                    <li class="hide_li">
                        <a href="customer_center.jsp" class="navi_hide_a">법인체후원</a>
                    </li>
                    <li class="hide_li">
            ...
            <div class="list_hide3">
                <ul class="hide_ul3">
                    ...
                    <li class="hide_li">
                        <a href="" class="navi_hide_a">후원자가이드</a> <!-- 미정  -->
                    </li>
                    <li class="hide_li">
                        <a href="customer_center.jsp" class="navi_hide_a">후원자선물가게</a><!-- 미정  -->
                    </li>
