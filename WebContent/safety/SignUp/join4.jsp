...
<div id="thisContent" class="container">
	...
	<div class="member-contents">
		<div class="contents"> 
			...
			<div id="middle">
			<a class="btn btn-dark" id="toHome" href="../mainpage/sf_mainpage.jsp" style="margin-top: 60px">홈으로 이동</a>
			</div>
			<div class="finish-grid-wrap"> 
				<ul>
					<li class="finish-grid-1" id="finish-grid-1"><a href="../activity/caminfor.jsp" class="none"
						title="후원자가이드 페이지 이동">
							<h2>후원이 처음이라면</h2>
							<h1>후원자가이드</h1> <i></i>
					</a></li>
					...
					<li class="finish-grid-3" id="finish-grid-3"><a href="../activity/campaign.jsp" class="none"
						title="소식보기 페이지 이동">
							<h2>후원이야기가 궁금하시면</h2>
							<h1>소식보기</h1> <i></i>
					</a></li>
