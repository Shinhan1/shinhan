...
<link rel="stylesheet" href="../support/personal_done_new.css" type="text/css" />
  ...
  <table class="table">
    ...
    <tr>
		...
		<tr>
			...
			<td style="border-right: hidden;"><input type="text" onkeypress="inNumber();" id="personboxDirect" name="personboxDirect" value="0" class="inputclass"/>&nbsp;&nbsp;원</td>
		</tr>
		<!-- ==================================================================== -->
		<tr>
			...
			<td style="border-right: hidden;"><input type="text" onkeypress="inNumber();" id="foreignboxDirect" name="foreignboxDirect" value="0"  class="inputclass"/>&nbsp;&nbsp;원</td>
		</tr>
			<!-- ==================================================================== -->
		<tr>
			...
			<td style="border-right: hidden;"><input type="text" onkeypress="inNumber();" id="koreaboxDirect" name="koreaboxDirect" value="0"  class="inputclass" />&nbsp;&nbsp;원</td>
		</tr>
			<!-- ==================================================================== -->
		<tr>
			...
			<td style="border-right: hidden;"><input type="text" onkeypress="inNumber();" id="emerboxDirect" name="emerboxDirect" value="0"  class="inputclass"/>&nbsp;&nbsp;원</td>
		</tr>
