...
<%@include file="../etc/sf_nav.jsp" %>
   ...
   <section class="statistic" id="about">
      <div class="col-12 col-lg-6 statistic-wrapper">
        ...
        <div class="statistic-box text-center" style="background-image: url(../image/SAF7.png);">
            <p>문의

         </div>
         <div class="statistic-box text-center" style="background-image: url(../image/SAF8.png);">
            <p>Q&A</p>

         </div>
		<div class="statistic-box text-center" style="background-image: url(../image/SAF9.png);">
            <p>후원가이드</p>
