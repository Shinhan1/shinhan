...
$(function() {
	...
	$('.btn1').click(function() { /* 휴대폰 번호로 비밀번호 찾기 */
		if (document.frm.name.value == "") { alert("아이디를 입력해 주세요."); document.frm.id.focus(); return; }
		if (document.frm.hpchoice.value == "") { alert("휴대폰번호를 입력해 주세요."); document.frm.pw.focus(); return; }
		if (document.frm.hpchoice2.value == "") { alert("휴대폰번호를 입력해 주세요."); document.frm.pw.focus(); return; }
		document.frm1.action="safetyFind_PW_OK1.jsp"
	...
	$('.btn2').click(function() {/* 이메일로 아이디 찾기  인증 필수 */
		if (document.frm.name.value == "") { alert("아이디를 입력해 주세요."); document.frm.id.focus(); return; }
		if (document.frm.email1.value == "") { alert("이메일를 입력해 주세요."); document.frm.pw.focus(); return; }
		if (document.frm.email2.value == "") { alert("이메일를 입력해 주세요."); document.frm.pw.focus(); return; }

		document.frm2.action="safetyFind_PW_OK2.jsp"
...
<div id ="inner">
	...
	<form action="safetyFind_PW_OK1.jsp" name ="frm2">
	   <div id="namefd_pw_email">
		<input type="text" title="아이디를 입력하세요." placeholder="아이디" name="name" id="name" autofocus="autofocus" style="padding-left: 10px;">

		</div>
        <div id="eamilinput">
        	<input class="email1 input-email" type="email" name="email1" id="email1" onkeyup="nonHangul3(this);" title="이메일를 입력해주세요."
        	placeholder=""
        	style="padding-left: 10px;">
        	@
