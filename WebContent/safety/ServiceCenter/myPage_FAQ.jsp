		...
		<div class="main">
				...
				<div class="boardBack">
					...
					<div class="boardBack_right">
						...
						<div class="bb_div">
							<ul id="bb_ul">
								<a href="myPage_FAQ.jsp">
									<li class="bb_li first" value="myPage_FAQ.jsp">전체</li>
								</a>
								<a href="myPage_FAQ.jsp?cctxt=후원관련">
									<li class="bb_li second" value="myPage_FAQ.jsp?cctxt=후원관련">후원관련</li>
								</a>
								<a href="myPage_FAQ.jsp?cctxt=결제관련">
									<li class="bb_li third" value="myPage_FAQ.jsp?cctxt=결제관련">결제관련</li>
								</a>
								<a href="myPage_FAQ.jsp?cctxt=기타">
									<li class="bb_li fourth" value="myPage_FAQ.jsp?cctxt=기타">기타</li>
								</a>
								<a href="inquiry.jsp">
									<li class="bb_li fifth" id="bb1_li" value="inquiry.jsp">나의 문의</li>
								</a>
							</ul>
						</div>
