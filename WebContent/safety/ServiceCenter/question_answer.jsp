		...
		<div class="boardBack">
			...
			<div class="under_bar">
				<div class="ub first">
					...
					<h3>후원가이드</h3>
					<p>후원이 처음이세요?</p>
					<a href="../support/caminfor.jsp"> <img src="../image/next1.png" alt=">" />
