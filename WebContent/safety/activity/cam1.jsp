...
<div style="width:1200px; margin: 0 0 0 360px;">
	...
	<div style="text-align: center; margin-top: 30px;"><input type="button" value="후원하기 " style="width: 185px; height: 68px; background-color: #da281f; color: white; font-size: 19px;" /></div>
	<div>
		<a href="campaign.jsp"><input class="btn1" type="button" value="목록" /></a>
		<a href="camwrite.jsp?bno=<%=vo.getBno() %>"><input class="btn1" type="button" value="수정" /></a>
