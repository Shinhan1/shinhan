...
<div style="width:1200px; margin:0 0 0 360px;">
	...
	<div style="text-align: center;"><input type="button" value="저소득 국내아동 후원하기 " style="width: 300px; height: 68px; background-color: #da281f; color: white; font-size: 19px;" /></div>
	<div>
