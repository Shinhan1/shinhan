...
<div style="width:1900px;">
	...
	<div style="text-align: center; margin-top: 30px;"><input type="button" value="학대피해 아동 후원하기 " style="width: 300px; height: 68px; background-color: #da281f; color: white; font-size: 19px;" /></div>
