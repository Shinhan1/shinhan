...
$(function() {
	...
	$('#mypagebtn').click(function(){
		...
		location="../myPage/myPage_detail1_1.jsp";
	});
...
<div class="navi_menu_div">
            <div class="navi_logo_div"><!-- 로고 부분  -->
                <a href="../mainpage/sf_mainpage.jsp" class="link"><img src="../../safety/image/sf_logo.png" alt="safetyLogo" id="navi_logo"/></a>
            </div>
...
<div class="list_hide_div">
            ...
            <div class="list_hide2">
                ...
                <ul class="hide_ul2">
                    ...
                    <li class="hide_li">
                        <a href="../support/support.jsp" class="navi_hide_a">후원금현황</a>
                    </li>
            ...
            <div class="list_hide3">
                <ul class="hide_ul3">
                    ...
                    <li class="hide_li">
                        <a href="../activity/caminfor.jsp" class="navi_hide_a">후원자가이드</a> <!-- 미정  -->
                    </li>
                    <li class="hide_li">
